  ...
  <div class="modal-content" style="width: 25%; background-color: currentColor;">
    ...
    <p style="color: white;" class="mx-auto">Borrar registro?</p>
     <div class="modal-footer justify-content-between ">
      ...
      <button id ="deleteLesseeBtn" type="button" data = "" class="btn btn-outline-light deleteCrud">Borrar</button>
    </div>
  </div>
                      ...
                      <tr id ="<?php echo $lessee['id'] ?>">
                        ...
                        <td>
                          <div class="row">
                            ...
                            <a class="btn btn-danger btn-sm col-lg-3 mx-auto deleteBtn" href="#" title="Borrar arrendatario" data ="<?php echo $lessee['id'] ?>" ><i class="fa fa-trash"></i></a>
                          </div>
                        </td>
                      </tr>
                    <?php endforeach ?>
