...
<?php ob_start(); ?>
<div class="card" style="max-width: 150%; min-width: 150%;">
                  ...
                  <tbody>
                    <?php foreach ($lessees as $lessee): ?>
                      <tr id ="<?php echo $lessee['id'] ?>">
                        ...
                        <td>
                          <div class="row">
                            <a class="btn btn-primary btn-sm col-lg-3 mx-auto" href="show_lessee_profile.php?id=<?php echo $lessee['id'] ?>" title="Ver"><i class="fa fa-folder"></i></a>
                            <a class="btn btn-info btn-sm col-lg-3 mx-auto" href="add_lessee.php?action=edit&id=<?php echo $lessee['id'] ?>" title="Editar"><i class="fa fa-pencil"></i></a>
                            <a class="btn btn-danger btn-sm col-lg-3 mx-auto deleteLesseeBtn" href="#" title="Borrar"><i class="fa fa-trash"></i></a>
                          </div>
                        </td>
                      </tr>
                    <?php endforeach ?>
