    ...
    <div class="card mr-4 card-warning  card-primary card-outline" style="max-width: 27%; min-width: 27%;">
            <div class="card-body box-profile">
                    ...
                    <div class="row mt-4">
                              ...
                              <a class="btn btn-danger btn-sm col-lg-5 mx-auto deleteLrProfileBtn" href="#">
                                  <i class="fa fa-trash">
                                  </i>
                                  Borrar
                              </a>
                                      ...
                                      <?php else: ?>
                                        <?php foreach ($properties as $property): ?>
                                          <tr>
                                            ...
                                            <td><a class="btn btn-primary btn-sm col-lg-12 mx-auto" href="show_property_profile.php?id=<?php echo $property['id'] ?>" title="Ver"><i class="fa fa-folder"></i></a></td>
                                          </tr>
                                        <?php endforeach ?>                                        
                                      <?php endif ?>
                                      <tr>
